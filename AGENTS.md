...
- **Frontend PRs**: Any change under `frontend/` must include desktop and mobile screenshots in the PR description, committed under `docs/screenshots/` per INSTRUCTIONS.md. Do not commit changes to `frontend/scripts/capture-screenshots.mjs` in feature PRs.
